                    ...
                    <div class="page-inner">
                        <div id="main-wrapper">
                            <div class="row" style="display:flex; justify-content:center;">
                                <div class="col-md-3">
                                    <div class="login-box">
                                        <a class="logo-name text-lg text-center">Basic Plan Pricing </a>
                                        <p class="text-center m-t-md">Add Basic Pricing</p>
                                        <?php if(isset( $_SESSION['success'])) {?>
                                        <div class="alert alert-success"><?=  $_SESSION['success']?></div>
                                        <?php } unset( $_SESSION['success'])?>
                                        <form class="m-t-md" action="basic_pricing_post.php" method="POST">
                                ...
                                <div class="col-md-3">
                                    <div class="login-box">
                                        ...
                                        <form class="m-t-md" action="basic_pricing_f_post.php" method="POST">
                                            <div class="form-group">
